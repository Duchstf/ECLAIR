set SynModuleInfo {
  ...
  {SRCNAME eclair MODELNAME eclair RTLNAME eclair IS_TOP 1
    SUBMODULES {
      ...
      {MODELNAME eclair_eclair_ap_fixed_const_ap_fixed_ap_fixed_16_6_4_0_0_const_ap_uint_2_P_3_RAM_2Pbkb RTLNAME eclair_eclair_ap_fixed_const_ap_fixed_ap_fixed_16_6_4_0_0_const_ap_uint_2_P_3_RAM_2Pbkb BINDTYPE storage TYPE ram_2p IMPL lutram LATENCY 2 ALLOW_PRAGMA 1}
