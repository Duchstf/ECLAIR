; ModuleID = '/home/dhoang/ECLAIR/demos/function_tracking/mlp_model/firmware/mlp/solution/.autopilot/db/a.g.ld.5.gdce.bc'
...
entry:
  ...
  call void @apatb_mlp_hw(i16* %input_copy4, i16* %output_copy5, i16* %feedback_copy6, %"struct.ap_uint<2>"* %zero_grad)
...
define void @"arraycpy_hls.p0a1struct.ap_fixed<16, 6, AP_RND_CONV, AP_SAT, 0>.68"(i16* nocapture "orig.arg.no"="0" "unpacked"="0.0" %dst, [1 x %"struct.ap_fixed<16, 6, AP_RND_CONV, AP_SAT, 0>"]* readonly "orig.arg.no"="1" "unpacked"="1" %src, i64 "orig.arg.no"="2" "unpacked"="2" %num) #1 {
entry:
...
copy:                                             ; preds = %entry
  call void @"arraycpy_hls.p0a1struct.ap_fixed<16, 6, AP_RND_CONV, AP_SAT, 0>.68"(i16* %dst, [1 x %"struct.ap_fixed<16, 6, AP_RND_CONV, AP_SAT, 0>"]* nonnull %src, i64 1)
  br label %ret
...
; Function Attrs: argmemonly noinline norecurse willreturn
define void @"arraycpy_hls.p0a1struct.ap_fixed<16, 6, AP_RND_CONV, AP_SAT, 0>.61"([1 x %"struct.ap_fixed<16, 6, AP_RND_CONV, AP_SAT, 0>"]* "orig.arg.no"="0" "unpacked"="0" %dst, i16* nocapture readonly "orig.arg.no"="1" "unpacked"="1.0" %src, i64 "orig.arg.no"="2" "unpacked"="2" %num) #1 {
entry:
...
; Function Attrs: argmemonly noinline norecurse willreturn
define internal void @"onebyonecpy_hls.p0a1struct.ap_fixed<16, 6, AP_RND_CONV, AP_SAT, 0>.58"([1 x %"struct.ap_fixed<16, 6, AP_RND_CONV, AP_SAT, 0>"]* noalias "orig.arg.no"="0" "unpacked"="0" %dst, i16* noalias nocapture readonly align 512 "orig.arg.no"="1" "unpacked"="1.0" %src) #2 {
entry:
  %0 = icmp eq [1 x %"struct.ap_fixed<16, 6, AP_RND_CONV, AP_SAT, 0>"]* %dst, null
  br i1 %0, label %ret, label %copy

copy:                                             ; preds = %entry
  call void @"arraycpy_hls.p0a1struct.ap_fixed<16, 6, AP_RND_CONV, AP_SAT, 0>.61"([1 x %"struct.ap_fixed<16, 6, AP_RND_CONV, AP_SAT, 0>"]* nonnull %dst, i16* %src, i64 1)
  br label %ret
...
entry:
  call void @"onebyonecpy_hls.p0a1struct.ap_fixed<16, 6, AP_RND_CONV, AP_SAT, 0>.58"([1 x %"struct.ap_fixed<16, 6, AP_RND_CONV, AP_SAT, 0>"]* %0, i16* align 512 %1)
  call void @"onebyonecpy_hls.p0a1struct.ap_fixed<16, 6, AP_RND_CONV, AP_SAT, 0>.58"([1 x %"struct.ap_fixed<16, 6, AP_RND_CONV, AP_SAT, 0>"]* %2, i16* align 512 %3)
  call void @"onebyonecpy_hls.p0a1struct.ap_fixed<16, 6, AP_RND_CONV, AP_SAT, 0>.58"([1 x %"struct.ap_fixed<16, 6, AP_RND_CONV, AP_SAT, 0>"]* %4, i16* align 512 %5)
  ret void
}

declare void @apatb_mlp_hw(i16*, i16*, i16*, %"struct.ap_uint<2>"*)
...
define void @mlp_hw_stub_wrapper(i16*, i16*, i16*, %"struct.ap_uint<2>"*) #5 {
entry:
  ...
  call void @mlp_hw_stub(%"struct.ap_fixed<16, 6, AP_RND_CONV, AP_SAT, 0>"* %7, %"struct.ap_fixed<16, 6, AP_RND_CONV, AP_SAT, 0>"* %8, %"struct.ap_fixed<16, 6, AP_RND_CONV, AP_SAT, 0>"* %9, %"struct.ap_uint<2>"* %3)
...
declare void @mlp_hw_stub(%"struct.ap_fixed<16, 6, AP_RND_CONV, AP_SAT, 0>"* noalias nocapture nonnull readonly, %"struct.ap_fixed<16, 6, AP_RND_CONV, AP_SAT, 0>"* noalias nocapture nonnull, %"struct.ap_fixed<16, 6, AP_RND_CONV, AP_SAT, 0>"* noalias nocapture nonnull readonly, %"struct.ap_uint<2>"* nocapture readonly)
